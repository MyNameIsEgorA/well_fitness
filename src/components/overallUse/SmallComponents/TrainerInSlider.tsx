...
const TrainerInSlider: FC<Trainer> = ({
    ...
    return (
        <SliderItemStyled onClick={() => setIsActive(!isActive)}>
            ...
            <div className="bottom mt-5 flex items-center">
                ...
                <Link className='text-white py-2 px-4 bg-softRed rounded flex items-center absolute bottom-2 right-3' href={'#'}>Купить</Link>
            </div>
        </SliderItemStyled>
    );
};
